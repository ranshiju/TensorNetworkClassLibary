def parameter_dmrg():
    ...
    para['l'] = 60  # Length of MPS
    para['chi'] = 12  # Virtual bond dimension cut-off
    para['d'] = 2  # Physical bond dimension
    para['sweep_time'] = 1  # sweep time
    # Fixed parameters
    para['if_print_detail'] = True
    para['tau'] = 1e-3  # shift to ensure the GS energy has the largest magnitude
    para['eigs_tol'] = 1e-10
    para['break_tol'] = 0  # tolerance for breaking the loop
    para['is_real'] = True
    para['dt_ob'] = 1  # in how many sweeps, observe to check the convergence
